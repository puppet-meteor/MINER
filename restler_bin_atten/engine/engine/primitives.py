...
FUZZABLE_ID_BEFORE="restler_fuzzable_id_before"
FUZZABLE_ID_AFTER="restler_fuzzable_id_after"
FUZZABLE_PROGRAM_LANGUAGE="restler_fuzzable_program_language"
FUZZABLE_BRANCH="restler_fuzzable_branch"
FUZZABLE_USER="restler_fuzzable_user"
FUZZABLE_TOKEN="restler_fuzzable_token"
FUZZABLE_PROJECT="restler_fuzzable_project"
FUZZABLE_ACCESS_LEVEL="restler_fuzzable_access_level"
FUZZABLE_GROUPACCESS="restler_fuzzable_groupaccess"
FUZZABLE_GROUPID="restler_fuzzable_groupid"
FUZZABLE_URL="restler_fuzzable_url"
FUZZABLE_REFNAME="restler_fuzzable_refname"
FUZZABLE_DATE="restler_fuzzable_date"
FUZZABLE_EXPIREDATE="restler_fuzzable_expiredate"
FUZZABLE_PROJECTNAME="restler_fuzzable_projectname"
FUZZABLE_FORKPROJECTNAME="restler_fuzzable_forkprojectname"
FUZZABLE_STARPROJECTNAME="restler_fuzzable_starprojectname"
FUZZABLE_GROUPNAME="restler_fuzzable_groupname"
FUZZABLE_EMAIL="restler_fuzzable_email"
FUZZABLE_COMPONENT="restler_fuzzable_component"
FUZZABLE_PRODUCT="restler_fuzzable_product"
FUZZABLE_BUGZILLAVERSION="restler_fuzzable_bugzillaversion"
FUZZABLE_GROUPID="restler_fuzzable_groupid"
FUZZABLE_USERADDPROJECTNAME="restler_fuzzable_useraddprojectname"
...
FUZZABLE_BOOLS="restler_fuzzable_bools"

FUZZABLE_ISSUEID="restler_fuzzable_issueid"
FUZZABLE_WORDPRESSTAG="restler_fuzzable_wordpresstag"
FUZZABLE_WORDPRESSCATEGORY="restler_fuzzable_wordpresscategory"
...
class CandidateValuesPool(object):
    ...
    def __init__(self):
        ...
        self.supported_primitive_types = [
            ...
            FUZZABLE_ID_BEFORE,
            FUZZABLE_ID_AFTER,
            FUZZABLE_PROGRAM_LANGUAGE,
            FUZZABLE_BRANCH,
            FUZZABLE_USER,
            FUZZABLE_PROJECT,
            FUZZABLE_ACCESS_LEVEL,
            FUZZABLE_PROJECTNAME,
            FUZZABLE_FORKPROJECTNAME,
            FUZZABLE_STARPROJECTNAME,
            FUZZABLE_GROUPACCESS,
            FUZZABLE_GROUPID,
            FUZZABLE_REFNAME,
            FUZZABLE_DATE,
            FUZZABLE_EXPIREDATE,
            FUZZABLE_USERADDPROJECTNAME,
            FUZZABLE_GROUPNAME,
            FUZZABLE_GROUPID,
            FUZZABLE_TOKEN,
            FUZZABLE_URL,
            ...
            FUZZABLE_BOOLS,
            FUZZABLE_ISSUEID,
            FUZZABLE_WORDPRESSTAG,
            FUZZABLE_WORDPRESSCATEGORY,
            FUZZABLE_IP
        ]
    ...
    def _create_fuzzable_dates(self):
        ...
        self._future_date = future.isoformat()
        oneday = datetime.timedelta(days=1)
        yesterday = today - oneday
        # self._past_date = yesterday.strftime(PAYLOAD_DATE_FORMAT)
        self._past_date = yesterday.isoformat()
...
def restler_fuzzable_id_before(*args, **kwargs):
...
def restler_fuzzable_id_after(*args, **kwargs):
...
def restler_fuzzable_branch(*args, **kwargs):
...
def restler_fuzzable_bools(*args, **kwargs):
...
def restler_fuzzable_program_language(*args, **kwargs):
...
def restler_fuzzable_component(*args, **kwargs):
...
def restler_fuzzable_product(*args, **kwargs):
...
def restler_fuzzable_bugzillaversion(*args, **kwargs):
...
def restler_fuzzable_user(*args, **kwargs):
...
def restler_fuzzable_groupaccess(*args, **kwargs):
...
def restler_fuzzable_groupid(*args, **kwargs):
...
def restler_fuzzable_groupname(*args, **kwargs):
...
def restler_fuzzable_refname(*args, **kwargs):
...
def restler_fuzzable_expiredate(*args, **kwargs):
...
def restler_fuzzable_access_level(*args, **kwargs):
...
def restler_fuzzable_project(*args, **kwargs):
...
def restler_fuzzable_projectname(*args, **kwargs):

    field_name = args[0]
    quoted = False
    if QUOTED_ARG in kwargs:
        quoted = kwargs[QUOTED_ARG]
    #print("sys._getframe().f_code.co_name: " + str(sys._getframe().f_code.co_name))
    #print("field_name: "+ str(field_name))
    #print("quoted: " + str(quoted))

    return sys._getframe().f_code.co_name, field_name, quoted



def restler_fuzzable_forkprojectname(*args, **kwargs):
...
def restler_fuzzable_starprojectname(*args, **kwargs):
...
def restler_fuzzable_useraddprojectname(*args, **kwargs):
...
def restler_fuzzable_token(*args, **kwargs):
...
def restler_fuzzable_issueid(*args, **kwargs):
...
def restler_fuzzable_wordpresscategory(*args, **kwargs):
...
def restler_fuzzable_wordpresstag(*args, **kwargs):
