...
import engine.transport_layer.response as response
...
if __name__ == '__main__':
    ...
    # print(args)
    # print('=====fuzzing requests=====')
    # for r in fuzzing_requests: print(r._definition)
    ...
    checkers = get_checker_list(req_collection, fuzzing_requests, args.enable_checkers or [],
                                args.disable_checkers or [], \
                                set_enable_first, settings.custom_checkers,
                                enable_default_checkers=args.fuzzing_mode != 'directed-smoke-test')
    ...
    datacollect.readdata()  # dictrequestid.pkl in readdata
    datacollect.starttime = datetime.datetime.now()
    print("starttime: " + str(datacollect.starttime))
    ...
    for lyui in range(len(datacollect.trainingset)):
        print(str(datacollect.trainingset[lyui]))

    print("lyu  trainingset400: ")
    for lyui in range(len(datacollect.trainingset400)):
    ...
    # print("datacollect.countid400: " + str(datacollect.countid400))

    # print("datacollect.gen200: " + str(datacollect.gen200))
    # print("datacollect.gen500: " + str(datacollect.gen500))
    # print("datacollect.gen400: " + str(datacollect.gen400))
    # print("datacollect.nogen200: " + str(datacollect.nogen200))
    # print("datacollect.nogen500: " + str(datacollect.nogen500))
    # print("datacollect.nogen400: " + str(datacollect.nogen400))

    # retrainingmodel_path = os.path.join(os.getcwd(),'retrainingmodel.txt')
    # with open(retrainingmodel_path, 'a') as f:
    #        f.write("mutation_list length: "+str(len(datacollect.mutationlist))+"\nnowtime: "+str(datetime.datetime.now())+"\n")
    #        f.write("seq_gen200: " + str(datacollect.seq_gen200) + "   seq_gen500: "+ str(datacollect.seq_gen500) +"   seq_gen400: "+ str(datacollect.seq_gen400) +"   seq_gen_num: "+ str(datacollect.seq_gen_num) +"\n")
    #        f.write("seq_nogen200: " + str(datacollect.seq_nogen200) + "   seq_nogen500: "+ str(datacollect.seq_nogen500) +"   seq_nogen400: "+ str(datacollect.seq_nogen400) +"   seq_nogen_num: "+ str(datacollect.seq_nogen_num) +"\n")
    #        f.write("payload_body_checker_former_200  _500  _400:  "+ str(datacollect.payload_body_checker_former_200) +"  "+str(datacollect.payload_body_checker_former_500)+"  "+str(datacollect.payload_body_checker_former_400) +"\n" +"payload_body_checker_laster_200  _500  _400:  " + str(datacollect.payload_body_checker_laster_200) +"  "+str(datacollect.payload_body_checker_laster_500)+"  "+str(datacollect.payload_body_checker_laster_400)+"\n")
    #        f.write("invalid_dynamic_object_checker_former_200  _500  _400:  " + str(datacollect.invalid_dynamic_object_checker_former_200) +"  "+str(datacollect.invalid_dynamic_object_checker_former_500) + "  "+ str(datacollect.invalid_dynamic_object_checker_former_400) +"\n")
    #        f.write("leakage_rule_checker_former_200  _500  _400:  " + str(datacollect.leakage_rule_checker_former_200) +"  "+str(datacollect.leakage_rule_checker_former_500) + "  "+ str(datacollect.leakage_rule_checker_former_400) +"\n")
    #        f.write("namespace_rule_checker_former_200  _500  _400:  "+ str(datacollect.namespace_rule_checker_former_200) +"  "+str(datacollect.namespace_rule_checker_former_500)+"  "+str(datacollect.namespace_rule_checker_former_400) +"\n" +"namespace_rule_checker_laster_200  _500  _400:  " + str(datacollect.namespace_rule_checker_laster_200) +"  "+str(datacollect.namespace_rule_checker_laster_500)+"  "+str(datacollect.namespace_rule_checker_laster_400)+"\n")
    #        f.write("resource_hierarchy_checker_former_200  _500  _400:  "+ str(datacollect.resource_hierarchy_checker_former_200) +"  "+str(datacollect.resource_hierarchy_checker_former_500)+"  "+str(datacollect.resource_hierarchy_checker_former_400) +"\n" +"resource_hierarchy_checker_laster_200  _500  _400:  " + str(datacollect.resource_hierarchy_checker_laster_200) +"  "+str(datacollect.resource_hierarchy_checker_laster_500)+"  "+str(datacollect.resource_hierarchy_checker_laster_400)+"\n")
    #        f.write("use_after_free_checker_laster_200  _500  _400:  " + str(datacollect.use_after_free_checker_laster_200) +"  "+str(datacollect.use_after_free_checker_laster_500) + "  "+ str(datacollect.use_after_free_checker_laster_400) +"\n")
    #        f.write("data_driven_checker_former_200  _500  _400:  "+ str(datacollect.data_driven_checker_former_200) +"  "+str(datacollect.data_driven_checker_former_500)+"  "+str(datacollect.data_driven_checker_former_400) +"\n" +"data_driven_checker_laster_200  _500  _400:  " + str(datacollect.data_driven_checker_laster_200) +"  "+str(datacollect.data_driven_checker_laster_500)+"  "+str(datacollect.data_driven_checker_laster_400)+"\n")

    # print("seq_seq_abnormal_writer: "+str(datacollect.seq_abnormal_writer))
    # print("seq_seq_normal_writer: "+str(datacollect.seq_normal_writer))
    # print("seq_seq_abnormal_consumer: "+str(datacollect.seq_abnormal_consumer))

    http_status_codes_path = os.path.join(os.getcwd(), 'http_status_codes.txt')
    with open(http_status_codes_path, 'w') as f:
        for item in response.codes:
            f.write(f"{item[0]},{item[1]},{item[2]}\n")

    print("seq_part_200: " + str(datacollect.seq_part_200))
    print("seq_part_400: " + str(datacollect.seq_part_400))
    print("seq_part_500: " + str(datacollect.seq_part_500))
    print("seq_part_non200: " + str(datacollect.seq_part_non200))
    print("seq_overall_200: " + str(datacollect.seq_overall_200))
    print("seq_overall_400: " + str(datacollect.seq_overall_400))
    print("seq_overall_500: " + str(datacollect.seq_overall_500))
    print("seq_overall_non200: " + str(datacollect.seq_overall_non200))
