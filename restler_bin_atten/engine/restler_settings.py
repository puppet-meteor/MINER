...
DYN_OBJECTS_CACHE_SIZE_DEFAULT = 30 #10
FUZZING_MODE_DEFAULT = 'random-walk' #'bfs'
...
MAX_COMBINATIONS_DEFAULT = 12320
...
class RestlerSettings(object):
    ...
    def __init__(self, user_args):
        ...
        self._fuzzing_mode = SettingsArg('fuzzing_mode', str, 'random-walk', user_args) #FUZZING_MODE_DEFAULT, user_args)
